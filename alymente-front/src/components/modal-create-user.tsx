...
import {
  ...
  signos,
  tiposSanguineos,
} from "@/utils/userModalFormSchema";
                ...
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <SelectContent>
                        {signos.map((signo) => (
                          <SelectItem value={signo}>{signo}</SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Joao Jose" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder="Selecione um tipo sanguineo" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        {tiposSanguineos.map((tiposSanguineo) => (
                          <SelectItem value={tiposSanguineo}>
                            {tiposSanguineo}
                          </SelectItem>
                        ))}
                      </SelectContent>
